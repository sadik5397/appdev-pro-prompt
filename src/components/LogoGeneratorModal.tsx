...
export const LogoGeneratorModal: React.FC<LogoGeneratorModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#05070C]/80 backdrop-blur-sm animate-fadeIn overflow-y-auto">
      <div className="relative w-full max-w-lg bg-[#111622] rounded-lg border border-[#1E2638] p-5 shadow-2xl my-6">
        {/* Close Button */}
        <button
          onClick={onClose}
        ...
        <div className="flex justify-between items-center mb-4">
          ...
          <span className="text-[11px] text-slate-500">Aspect Ratio: 1:1 Square</span>
        </div>
